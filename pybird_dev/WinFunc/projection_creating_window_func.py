...
class Projection(object):
    ...
    def __init__(
        ...
        window_fourier_name = r"Beutleretal_window_kspace_z1_NGC.dat",
        #path_to_window=None,
        path_to_window = r"mnt\c\Users\s4393083\pybird\tbird",
        #window_configspace_file=None, #Original
        window_configspace_file = "Beutleretal_window_z1_NGC.dat",
        binning=False,
        fibcol=False,
        Nwedges=0,
        zz=None,
    ...
    def setWindow(self, load=True, save=True, Nl=3, withmask=True, windowk=0.05):
        ...
        if self.co.with_cf:
            try:
                ...
                swindow_config_space=np.loadtxt("Beutleretal_window_z1_NGC.dat", skiprows=1, usecols=range(0,2,3,4)) #Manually defined like a scrub
            ...
            #window_fourier_file = os.path.join("%s_Nl%s_kmax%.2f.npy") % ( #Defined w.r.t local path, reads window func
                r"Beutleretal_window_kspace_z1_NGC",
                self.co.Nl,
                self.co.kmax,
            )
            ...
            if not load:  # do not change to else
                ...
                if self.window_configspace_file is None:
                    ...
                    try:
                        ...
                        swindow_config_space=np.loadtxt("Beutleretal_window_z1_NGC.dat", skiprows=1, usecols=(0,2,3,4)) #Skipping dummy in case not supposed to be used
                        print(swindow_config_space[2800, :])
        ...
        if compute is True:
            ...
            if self.co.with_cf:
                ...
                if save:
                    ...
                    print("saving mask:")
                    np.save("Beutleretal_window_kspace_z1_NGC_Nl3_kmax0.60.npy", self.Wal)
