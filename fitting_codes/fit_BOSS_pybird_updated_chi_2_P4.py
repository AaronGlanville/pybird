...
if __name__ == "__main__":
    ...
    ndim = 5 + (2*len(pardict["z_pk"])) #only using b1, c2

    dsampler = NestedSampler(lnlike, prior_transform, ndim, logl_args=[birdmodels, fittingdata, plt], ptform_args=[birdmodels], nlive=50, bound='multi', sample='unif')
    dsampler.run_nested()
    dres=dsampler.results
    print(dres)
    np.save("z1_z2_z3_curved_true_data/100x50_z123_kmax_0p23_0p23_0p23_knl_0p6_curved_true_data_2x_eft_prior_reduced_ce_updated_SN_"+str(input_num), dres)
    #np.save("z1_z2_z3_curved_mock_mean_data/100x50_local_pybird_z1_z2_z3_updated_chi_2_with_resum_optiresum_false_order_4_kmax_0p20_0p20_0p20_knl_0p5_curved_mock_mean_"+str(input_num), dres)
